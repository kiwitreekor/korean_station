...
OBJFILES_PART2 = $(addprefix obj/stations/,kws_part2.grf sprites.grf switches.grf crossings_high.grf psd_extra.grf buffers.grf seoul.grf gangneung.grf gwangmyeong.grf metro.grf suseo.grf overpass_stairs.grf sinhaeundae.grf jije.grf signals.grf hannam.grf sindaebang.grf jungnang.grf strings_part2.grf) 
