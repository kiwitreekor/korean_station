...
OBJFILES_PART3 = $(addprefix obj/stations/,kws_part3.grf sprites.grf railtypes.grf switches.grf platform_ends.grf depots.grf cheongnyangni.grf strings_part3.grf)
