...
OBJFILES_PART2 = $(addprefix obj/stations/,kws_part2.grf sprites.grf railtypes.grf switches.grf crossings_high.grf psd_extra.grf buffers.grf seoul.grf gangneung.grf \
	gwangmyeong.grf metro.grf suseo.grf overpass_stairs.grf sinhaeundae.grf jije.grf signals.grf hannam.grf sindaebang.grf jungnang.grf strings_part2.grf) 
OBJFILES_PART3 = $(addprefix obj/stations/,kws_part3.grf sprites.grf railtypes.grf switches.grf platform_ends.grf depots.grf cheongnyangni.grf ilsan.grf strings_part3.grf)
