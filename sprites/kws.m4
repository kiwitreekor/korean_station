...
define(PSD_PLATFORM_A_LIST_PART1, {PSD_HP_A, PSD_HP_A_RF_A, PSD_HP_A_RF_B})
define(PSD_PLATFORM_B_LIST_PART1, {PSD_HP_B, PSD_HP_B_RF_A, PSD_HP_B_RF_B})
define(PSD_PLATFORM_C_LIST_PART1, {PSD_HP_C, PSD_HP_C_RF_A, PSD_HP_C_RF_B})
...
define(PSD_PLATFORM_A_LIST_PART2, {PSD_OVERPASS_HP_A, PSD_OVERPASS_HP_A_RF_A, PSD_OVERPASS_HP_A_RF_B, PSD_MODULAR_LOW_HP_A, PSD_MODULAR_HIGH_HP_A, PSD_UNDERPASS_HP_A_RF_A, PSD_UNDERPASS_HP_A_RF_B})
define(PSD_PLATFORM_B_LIST_PART2, {PSD_OVERPASS_HP_B, PSD_OVERPASS_HP_B_RF_A, PSD_OVERPASS_HP_B_RF_B, PSD_MODULAR_LOW_HP_B, PSD_MODULAR_HIGH_HP_B, PSD_UNDERPASS_HP_B_RF_A, PSD_UNDERPASS_HP_B_RF_B})
define(PSD_PLATFORM_C_LIST_PART2, {PSD_OVERPASS_HP_C, PSD_OVERPASS_HP_C_RF_A, PSD_OVERPASS_HP_C_RF_B, PSD_MODULAR_LOW_HP_C, PSD_MODULAR_HIGH_HP_C, PSD_UNDERPASS_HP_C_RF_A, PSD_UNDERPASS_HP_C_RF_B})
