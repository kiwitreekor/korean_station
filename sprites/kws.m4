...
define(SIGN_B_HP_A_RF_A, 0x46)
define(SIGN_B_HP_A_RF_B, 0x47)
define(SIGN_B_LP_A_RF_A, 0x48)
define(SIGN_B_LP_A_RF_B, 0x49)
define(SIGN_B_LAP_A_RF_A, 0x4A)
define(SIGN_B_LAP_A_RF_B, 0x4B)
define(PLATFORM_SIGN_B_ADDITIONAL_END, 0x4B)
...
define(HIGH_PLATFORM_A_PART1, {HP_A, HP_A_RF_A, HP_A_RF_B, OVERPASS_HP_A, OVERPASS_HP_A_RF_A, OVERPASS_HP_A_RF_B, MODULAR_LOW_HP_A, MODULAR_HIGH_HP_A, SIGN_A_HP_A, SIGN_C_HP_A, SIGN_C_HP_A_RF_A, SIGN_C_HP_A_RF_B, LED_HP_A_RF_A, LED_HP_A_RF_B, WAITINGROOM_HP_A, WAITINGROOM_HP_A_RF_A, WAITINGROOM_HP_A_RF_B, LIGHT_HP_A, UNDERPASS_HP_A_RF_A, UNDERPASS_HP_A_RF_B, PSD_HP_A, PSD_HP_A_RF_A, PSD_HP_A_RF_B})
...
define(LOW_PLATFORM_A_PART1, {LP_A, LP_A_RF_A, LP_A_RF_B, CROSSING_LP_A, CROSSING_LP_A_RF_A, CROSSING_LP_A_RF_B, OVERPASS_LP_A, OVERPASS_LP_A_RF_A, OVERPASS_LP_A_RF_B, MODULAR_LOW_LP_A, MODULAR_HIGH_LP_A, SIGN_A_LP_A, SIGN_C_LP_A, SIGN_C_LP_A_RF_A, SIGN_C_LP_A_RF_B, LED_LP_A_RF_A, LED_LP_A_RF_B, WAITINGROOM_LP_A, WAITINGROOM_LP_A_RF_A, WAITINGROOM_LP_A_RF_B, LIGHT_LP_A, UNDERPASS_LP_A_RF_A, UNDERPASS_LP_A_RF_B})
...
define(HIGH_PLATFORM_B_PART2, {CROSSING_HP_B, CROSSING_HP_B_RF_A, CROSSING_HP_B_RF_B, PSD_OVERPASS_HP_B, PSD_OVERPASS_HP_B_RF_A, PSD_OVERPASS_HP_B_RF_B, PSD_MODULAR_LOW_HP_B, PSD_MODULAR_HIGH_HP_B, PSD_UNDERPASS_HP_B_RF_A, PSD_UNDERPASS_HP_B_RF_B, BUFFER_HP_B, BUFFER_HP_B_RF_A, BUFFER_HP_B_RF_B, METRO_HP_B, METRO_EXIT_SOUTH_HP_B, METRO_EXIT_NORTH_HP_B})
define(HIGH_PLATFORM_C_PART2, {CROSSING_HP_C, CROSSING_HP_C_RF_A, CROSSING_HP_C_RF_B, PSD_OVERPASS_HP_C, PSD_OVERPASS_HP_C_RF_A, PSD_OVERPASS_HP_C_RF_B, PSD_MODULAR_LOW_HP_C, PSD_MODULAR_HIGH_HP_C, PSD_UNDERPASS_HP_C_RF_A, PSD_UNDERPASS_HP_C_RF_B, BUFFER_HP_C, BUFFER_HP_C_RF_A, BUFFER_HP_C_RF_B, METRO_HP_C, METRO_EXIT_SOUTH_HP_C, METRO_EXIT_NORTH_HP_C})

define(LOW_PLATFORM_A_PART2, {BUFFER_LP_A, BUFFER_LP_A_RF_A, BUFFER_LP_A_RF_B, METRO_LP_A, METRO_EXIT_SOUTH_LP_A, METRO_EXIT_NORTH_LP_A})
define(LOW_PLATFORM_B_PART2, {BUFFER_LP_B, BUFFER_LP_B_RF_A, BUFFER_LP_B_RF_B, METRO_LP_B, METRO_EXIT_SOUTH_LP_B, METRO_EXIT_NORTH_LP_B})
define(LOW_PLATFORM_C_PART2, {BUFFER_LP_C, BUFFER_LP_C_RF_A, BUFFER_LP_C_RF_B, METRO_LP_C, METRO_EXIT_SOUTH_LP_C, METRO_EXIT_NORTH_LP_C})
