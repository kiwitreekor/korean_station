...
define(tmpl_seoul_part1_roof, {
		sprite(ifelse($1,,,{$1,})
		       $2 8bpp eval($3)    eval($4) 78 39 ifelse($5,CHILDSPRITE_FALSE,{-44 -2},{0 0}) normal) ifelse($1,,,{// $1})
...
define(tmpl_seoul_part4B, {
		sprite(ifelse($1,,,{$1,})
		       $2 8bpp eval($3)     eval($4)     32 144 -29 -113 normal) ifelse($1,,,{// $1})
		sprite($2 8bpp eval($3+524) eval($4)     32 144  -1 -113 normal)
		sprite($2 8bpp eval($3+32)  eval($4)     64 128 -29  -97 normal)
		sprite($2 8bpp eval($3+460) eval($4)     64 128 -33  -97 normal)
		sprite($2 8bpp eval($3+96)  eval($4)     32  96   3  -81 normal)
		sprite($2 8bpp eval($3+428) eval($4)     32  96 -33  -81 normal)
		sprite($2 8bpp eval($3+128) eval($4)     32  80   3  -65 normal)
		sprite($2 8bpp eval($3+396) eval($4)     32  80 -33  -65 normal)
		sprite($2 8bpp eval($3+160) eval($4)     32  64   3  -49 normal)
		sprite($2 8bpp eval($3+364) eval($4)     32  64 -33  -49 normal)
		sprite($2 8bpp eval($3+192) eval($4)     32  48   3  -33 normal)
		sprite($2 8bpp eval($3+332) eval($4)     32  48 -33  -33 normal)
		
		sprite($2 8bpp eval($3+32)  eval($4+128) 64  32 -29   -1 normal)
		sprite($2 8bpp eval($3+460) eval($4+128) 64  32 -33   -1 normal)
		sprite($2 8bpp eval($3+96)  eval($4+96)  32  48   3  -17 normal)
		sprite($2 8bpp eval($3+428) eval($4+96)  32  48 -33  -17 normal)
		sprite($2 8bpp eval($3+128) eval($4+80)  32  48   3  -17 normal)
		sprite($2 8bpp eval($3+396) eval($4+80)  32  48 -33  -17 normal)
		sprite($2 8bpp eval($3+160) eval($4+64)  32  48   3  -17 normal)
		sprite($2 8bpp eval($3+364) eval($4+64)  32  48 -33  -17 normal)
		sprite($2 8bpp eval($3+192) eval($4+48)  32  48   3  -17 normal)
